...
vlog -vlog01compat -work work +incdir+C:/GitHub_Repos/FPGALearning/TrafficLight {C:/GitHub_Repos/FPGALearning/TrafficLight/baseline_c5gx.v}
vlog -sv -work work +incdir+C:/GitHub_Repos/FPGALearning/TrafficLight {C:/GitHub_Repos/FPGALearning/TrafficLight/SevenSegmentInd.sv}
vlog -sv -work work +incdir+C:/GitHub_Repos/FPGALearning/TrafficLight {C:/GitHub_Repos/FPGALearning/TrafficLight/Counter.sv}
vlog -sv -work work +incdir+C:/GitHub_Repos/FPGALearning/TrafficLight {C:/GitHub_Repos/FPGALearning/TrafficLight/TrafficLight.sv}
vlog -sv -work work +incdir+C:/GitHub_Repos/FPGALearning/TrafficLight {C:/GitHub_Repos/FPGALearning/TrafficLight/TrafficLightControl.sv}
vlog -sv -work work +incdir+C:/GitHub_Repos/FPGALearning/TrafficLight {C:/GitHub_Repos/FPGALearning/TrafficLight/Button.sv}

vlog -sv -work work +incdir+C:/GitHub_Repos/FPGALearning/TrafficLight {C:/GitHub_Repos/FPGALearning/TrafficLight/Button_tb.sv}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  Button_tb
